...
@Controller
/* Sotto-Controller dipendente da Cliente controller, mappato ad una sotto ruta. */
...
public class FacturaController {
	...
	/* Vamos a mapear a la ruta eliminar/{id}. */
	...
	public String eliminar(@PathVariable(value = "id") Long id, RedirectAttributes flash) {
		...
		if (factura != null) {
			...
			flash.addFlashAttribute("success", "Scontrino eliminato con successo!.");

			return "redirect:/ver/" + factura.getCliente().getId();
		}
		flash.addFlashAttribute("error", "Lo scontrino non esiste nel DB!.");
